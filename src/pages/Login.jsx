      ...
      <div className='pt-12 flex justify-center justify-items-center'>
        <form className='shadow-md rounded px-8 pt-6 pb-8 mb-4 bg-gray-300'>
          <div className='border-b border-indigo-500 py-2 mb-4'>
            <input type="text" className='appearance-none bg-transparent border-none w-full text-gray-900 mr-3 focus:border-transparent focus:ring-0' placeholder="username" name="username" required/>
          </div>
          <div className='border-b border-indigo-500 py-2 mb-8'>
            <input type="password" className='appearance-none bg-transparent border-none w-full text-gray-900 mr-3 focus:border-transparent focus:ring-0' placeholder="password" name="password" required />
          </div>
